...
if os.getenv('OPTIMIZER_DIR') is None:
    os.environ['OPTIMIZER_DIR'] = os.path.dirname(os.path.abspath(__file__))
...
if os.path.exists(f"{os.getenv('OPTIMIZER_DIR')}/losses") == False:
    os.mkdir(f"{os.getenv('OPTIMIZER_DIR')}/losses")
if os.path.exists(f"{os.getenv('OPTIMIZER_DIR')}/models") == False:
